...
def test_ok_page1(api_connection_es, print_job):
    page = api_connection_es.get("logs/ref", params={"ref": print_job})
    print(page)
...
def test_ok_page2(api_connection_es, print_job):
    page = api_connection_es.get("logs/ref", params={"ref": print_job, "pos": 2})
    print(page)
    assert print_job in page
...
def test_filter(api_connection_es, print_job):
